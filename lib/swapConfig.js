...
// Pools created via ArrowFactory.createPool() (clones of ARROW_POOL_IMPLEMENTATION_ADDRESS).
export const USDC_CIRBTC_POOL_ADDRESS = '0x9E101608ae520bCf1466c7C02F3D43aEcBCE2A81';
export const EURC_CIRBTC_POOL_ADDRESS = '0x52a98B72C7621A52C19bA9ADE36739aab6F94AFF';
...
export const TOKENS = [
  ...
  // Confirmed against Circle's own docs (developers.circle.com/assets/cirbtc-contract-addresses).
  { symbol: 'cirBTC', name: 'Circle Bitcoin', address: CIRBTC_ADDRESS, decimals: 8, color: 'from-danger to-[#b23f5c]', logo: '/fonts/tokens/cirBTC.png', disabled: false },
];
...
export const POOLS = [
  ...
  { key: 'usdcCirbtc', type: 'pool', address: USDC_CIRBTC_POOL_ADDRESS, tokenA: 'USDC', tokenB: 'cirBTC' },
  { key: 'eurcCirbtc', type: 'pool', address: EURC_CIRBTC_POOL_ADDRESS, tokenA: 'EURC', tokenB: 'cirBTC' },
];
